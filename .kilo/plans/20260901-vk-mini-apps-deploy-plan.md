...
- Бампа версии кэша в `sw.js` **не требуется**: на хостинге VK URL меняется после каждой выкладки, сервис-воркер переходит на новый scope, кэш инвалидируется автоматически.
